...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/css/token-input-bootstrap.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>custom.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>scripts/markitup/skins/simple/style.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>scripts/markitup/sets/default/style.css" />
	<script type="text/javascript" src="<?php echo site_url(); ?>scripts/markitup/jquery.markitup.js"></script>
	<script type="text/javascript" src="<?php echo site_url(); ?>scripts/markitup/sets/default/set.js"></script>
</head>
			...
			<header id="cwd-header">
				...
				<div class="container">
					...
					<hgroup id="cwd-hgroup">
						...
						<h1>Badges<small>Alpha</small></h1>
					</hgroup>
